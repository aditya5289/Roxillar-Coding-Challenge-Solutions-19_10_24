                ...
                datasets: [
                    {
                        ...
                        borderColor: 'rgba(0, 123, 255, 1)', // Solid blue color for border
                        borderWidth: 1,
                    },
                ],
            };
        ...
        scales: {
            y: {
                ...
                title: {
                    ...
                    font: {
                        size: 20, // Set Y-axis title font size to 20
                    },
                },
                ticks: {
                    precision: 0, // Set tick precision to 0 for integer values
                    font: {
                        size: 20, // Set Y-axis ticks font size to 20
                    },
                },
            },
            x: {
                title: {
                    display: true,
                    text: 'Price Range in Dollars($)', // X-axis title
                    font: {
                        size: 20, // Set X-axis title font size to 20
                    },
                },
                ticks: {
                    font: {
                        size: 20, // Set X-axis ticks font size to 20
                    },
                },
            },
        },
