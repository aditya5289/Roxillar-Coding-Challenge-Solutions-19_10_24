                ...
                <Table sx={{ minWidth: 700, borderCollapse: 'collapse' }}>
                    <TableHead>
                        <TableRow>
                            ...
                            <TableCell sx={{ border: '1px solid #ddd', textAlign: 'center', backgroundColor: 'primary.main', color: 'white', fontWeight: 'bold' }}>Item Image</TableCell>
                            ...
                            transactions.length > 0 ? (
                                transactions.map((transaction, index) => (
                                    <TableRow key={transaction._id}>
                                        ...
                                        <TableCell sx={{ border: '1px solid #ddd' }}>{formatDate(transaction.dateOfSale)}</TableCell> {/* Updated date formatting */}
                                    </TableRow>
                                ))
                            ) : (
                                <TableRow>
